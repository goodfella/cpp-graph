#ifndef NGMG_MATCH_CLAUSE_HPP
#define NGMG_MATCH_CLAUSE_HPP
...
namespace ngmg::cypher
{
    ...
    class match_clause
    {
        ...
        explicit
        match_clause(const Node_Exps &);

        explicit
        match_clause(const Rel_Exps &);

        match_clause(const Node_Exps &, const Rel_Exps &);
    ...
    struct is_match_clause: public std::false_type {};

    template <class T, class U>
    struct is_match_clause<match_clause<T,U>>: public std::true_type {};

    template<ngmg::cypher::NodeExpressionTuple Node_Exps,
             ngmg::cypher::RelationshipExpressionTuple Rel_Exps>
    match_clause<Node_Exps, Rel_Exps>::match_clause(const Node_Exps & node_exps):
        _node_expressions(node_exps)
    {}

    template<ngmg::cypher::NodeExpressionTuple Node_Exps,
             ngmg::cypher::RelationshipExpressionTuple Rel_Exps>
    match_clause<Node_Exps, Rel_Exps>::match_clause(const Rel_Exps & relationship_exps):
    ...
    template<ngmg::cypher::NodeExpressionTuple Node_Exps,
             ngmg::cypher::RelationshipExpressionTuple Rel_Exps>
    void
    match_clause<Node_Exps, Rel_Exps>::write(std::ostream & stream) const
    {
